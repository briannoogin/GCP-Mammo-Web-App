...
# def load_data(job_dir,**args):
#     labels = []
#     with open("train_classes.txt",'r') as label_file:
#         for line in label_file:
#             labels.append(int(line.split()[0]))
#     data = []
#     path = "gs://cbis-ddsm-cnn/data/training_file.pickle"
#     for file in file_io.get_matching_files("gs://cbis-ddsm-cnn/data/train/*"):
#         with file_io.FileIO(file,'r') as f:
#             data.append(f.read())
#     # with file_io.FileIO(path, mode='r') as file_stream:
#     #     file = file_stream.read()
#     #     print(file)
#     #     x_train, y_train = pickle.loads(file_stream)
#     print(data)
...
def train_model(model,job_dir,**args):
    ...
    train_generator = flow_from_google_storage(
        train_datagen,
        'CBIS DDSM CNN',
        'cbis-ddsm-cnn',
        'data/train',
...
# code from stack overflow and allows to use flow from directory from google storage
